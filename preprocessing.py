...
from utils import check_folder, cov_path, covid_masks_path, non_cov_path, non_covid_masks_path
...
class Preprocessing:
    def __init__(self):
        ...
        self.non_covid_path = non_cov_path
        self.non_covid_masks_path = non_covid_masks_path
